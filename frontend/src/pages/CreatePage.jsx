  ...
  const handleSubmit = async (e) => {
    ...
    try{
      await api.post('/books', {title, author, publishYear:Number(publishYear) })
        toast.success('Book created succressfully!')
        navigate('/')
    } catch (error) {
    ...
    <div className='min-h-screen bg-case-200'>
      <div className='container mx-auto px-4 py-8 '>
        <div className='max-w-2xl mx-auto'>
          ...
          <input type="text" placeholder='Book title' className='input input-bordered' value={title} onChange={(e) =>
          ...
          <input type="text" placeholder='Book Author' className='input input-bordered' value={author} onChange={(e) =>
