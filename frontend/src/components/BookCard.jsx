...
import {BookOpen, UserCircle, Info, Edit2, Trash2, Book, StepBack, TreePalm} from 'lucide-react'
...
return(
  ...
  bg-base-100 p-4 border-transition-all duration-200 ${isActive ? "border-primary shadow-lg": "border-base-300"}
  hover:border-primary hover:shadow-xl `}>
    ...
    <span className='text-xs text-base-content/60'> {formatDate(new Date(book.createdAt))} 
    </span>
    ...
    {" "}"{book.title}" </span>? <br /> This action cannot by undone. </p>
    <div className='modal-action'>
      <button className='btn btn-ghost' onClick={() => setShowModel(false)}> Cancel </button>
